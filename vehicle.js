...
function fakeData(){
    ...
    for (let i = 0; i < 5; i++){
        ...
        localStorage.setItem(myVehicle.getName(), jsonString);
...
function displayVehicle(vehicle = myVehicleDA.queryResults[1]){
...
function finishedCards(data = myVehicleDA.queryResults) {
    ...
    for (let i = 0; i < data.length; i++){
        ...
        const tempVehicle = new Vehicle(jsonObject.vehicleType, jsonObject.name, jsonObject.priceDay, jsonObject.priceHour, jsonObject.make, jsonObject.model, jsonObject.description, jsonObject.image)
